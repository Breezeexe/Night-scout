...
class SecretFinding(BaseModel):
    """Redacted possible-secret evidence.

    This model intentionally has no raw-secret field.
    """
    ...
    async def scan(
        ...
        *,
        ...
        for payload in lines:
            ...
            # Important: Raw, Redacted, RawV2, StructuredData and verification
            # material are intentionally ignored and never copied to Events.
            findings.append(
                SecretFinding(
                    detector=self.name,
                    secret_type=detector_name,
